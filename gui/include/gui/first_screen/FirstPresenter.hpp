...
*
*****************************************************************************/
#ifndef FIRST_PRESENTER_HPP
#define FIRST_PRESENTER_HPP
...
/**
* The Presenter for a First screen. In the MVP paradigm, the presenter acts upon
...
*
*/
class FirstPresenter : public Presenter, public ModelListener
{
public:
