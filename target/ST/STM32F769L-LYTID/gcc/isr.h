...
void RNG_IRQHandler(void) __attribute__((__interrupt__));
...
void SAI2_IRQHandler(void) __attribute__((__interrupt__));
void QUADSPI_IRQHandler(void) __attribute__((__interrupt__));
void LPTIM1_IRQHandler(void) __attribute__((__interrupt__));
void CEC_IRQHandler(void) __attribute__((__interrupt__));
void I2C4_EV_IRQHandler(void) __attribute__((__interrupt__));
void I2C4_ER_IRQHandler(void) __attribute__((__interrupt__));
void SPDIF_RX_IRQHandler(void) __attribute__((__interrupt__));
//void DSI_IRQHandler(void) __attribute__((__interrupt__));
void DFSDM1_FLT0_IRQHandler(void) __attribute__((__interrupt__));
void DFSDM1_FLT1_IRQHandler(void) __attribute__((__interrupt__));
void DFSDM1_FLT2_IRQHandler(void) __attribute__((__interrupt__));
void DFSDM1_FLT3_IRQHandler(void) __attribute__((__interrupt__));
void SDMMC2_IRQHandler(void) __attribute__((__interrupt__));
void CAN3_TX_IRQHandler(void) __attribute__((__interrupt__));
void CAN3_RX0_IRQHandler(void) __attribute__((__interrupt__));
void CAN3_RX1_IRQHandler(void) __attribute__((__interrupt__));
void CAN3_SCE_IRQHandler(void) __attribute__((__interrupt__));
void JPEG_IRQHandler(void) __attribute__((__interrupt__));
void MDIOS_IRQHandler(void) __attribute__((__interrupt__));
