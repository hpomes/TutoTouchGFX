...
void MyUART0_IRQHandler(void) __attribute__((__interrupt__));
void PMW1_IRQHandler(void) __attribute__((__interrupt__));
void I2C2_IRQHandler(void) __attribute__((__interrupt__));
void PLL0_IRQHandler(void) __attribute__((__interrupt__));
void EINT0_IRQHandler(void) __attribute__((__interrupt__));
void EINT1_IRQHandler(void) __attribute__((__interrupt__));
void EINT2_IRQHandler(void) __attribute__((__interrupt__));
void EINT3_IRQHandler(void) __attribute__((__interrupt__));
void ADC_IRQHandler(void) __attribute__((__interrupt__));
void BOD_IRQHandler(void) __attribute__((__interrupt__));
void USB_IRQHandler(void) __attribute__((__interrupt__));
void CAN_IRQHandler(void) __attribute__((__interrupt__));
void GPDMA_IRQHandler(void) __attribute__((__interrupt__));
void I2S_IRQHandler(void) __attribute__((__interrupt__));
void ENET_IRQHandler(void) __attribute__((__interrupt__));
void MCI_IRQHandler(void) __attribute__((__interrupt__));
void PLL1_IRQHandler(void) __attribute__((__interrupt__));
void USBACT_IRQHandler(void) __attribute__((__interrupt__));
void CANACT_IRQHandler(void) __attribute__((__interrupt__));
void UART4_IRQHandler(void) __attribute__((__interrupt__));
void SSP2_IRQHandler(void) __attribute__((__interrupt__));
void MyGPIO_IRQHandler(void) __attribute__((__interrupt__));
void PWM0_IRQHandler(void) __attribute__((__interrupt__));
void KFLASH_IRQHandler(void) __attribute__((__interrupt__));
void PWM1_IRQHandler(void) __attribute__((__interrupt__));
